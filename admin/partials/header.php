...
<nav><a class="<?= $activePage==='dashboard'?'active':'' ?>" href="index.php">▦ <span>Dashboard</span></a><a class="<?= $activePage==='rules'?'active':'' ?>" href="rules.php">≡ <span>Rules</span></a><a class="<?= $activePage==='parameters'?'active':'' ?>" href="parameters.php">⌗ <span>Parameters</span></a><a class="<?= $activePage==='add'?'active':'' ?>" href="rule_edit.php">＋ <span>Add Rule</span></a><a class="<?= $activePage==='tester'?'active':'' ?>" href="tester.php">⌁ <span>API Tester</span></a></nav>
