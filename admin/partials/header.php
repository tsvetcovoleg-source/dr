...
<nav><a class="<?= $activePage==='dashboard'?'active':'' ?>" href="index.php">▦ <span>Dashboard</span></a><a class="<?= $activePage==='rules'?'active':'' ?>" href="rules.php">≡ <span>Rules</span></a><a class="<?= $activePage==='rule_sets'?'active':'' ?>" href="rule_sets.php">◫ <span>Rule Sets</span></a><a class="<?= $activePage==='parameters'?'active':'' ?>" href="parameters.php">⌗ <span>Parameters</span></a><?php if($auth->hasRole('RULE_EDITOR')||$auth->hasRole('RULE_APPROVER')):?><a class="<?= $activePage==='tester'?'active':'' ?>" href="tester.php">⌁ <span>API Tester</span></a><?php endif;?><?php if($auth->hasRole('ADMIN')):?><a class="<?= $activePage==='users'?'active':'' ?>" href="users.php">♙ <span>Users</span></a><?php endif;?></nav>
